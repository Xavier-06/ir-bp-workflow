...
| **投行估值研报/目标价方法论** | **IMA 研报库 `7498615127803592`**: `search_knowledge` 搜 `{可比公司名} 估值 目标价 研报` → fetch 全文 | 投行研报中的估值方法论 |
...
- 研报库 `7498615127803592`: `ima-mcp.search_knowledge` 搜 `{可比公司名} 估值 目标价 研报` → 取最相关 5-8 篇 `fetch_media_content` 读全文
