...
| **NeoData** | `cd {RUNTIME_ROOT} && python3 scripts/search/neodata_search.py "关键词" --json` | 上市客户营收/市值/利润 | 仅用于上市客户验证 |
  ...
  "products": [
    {
      ...
      "positioning": "产品定位",
      "core_features": ["核心功能"],
      "stage": "量产/试点/导入/研发/意向",
      "target_customers": ["目标客户"],
      "evidence_level": "已回款/已合同/已交付/试点/意向/BP自述"
    }
  ],
  "customers": [
    {
