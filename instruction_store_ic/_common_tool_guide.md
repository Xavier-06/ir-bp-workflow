...
# Step 2: 全文提取 → 挑最相关的研报逐篇取 media_id（每 step 至少读 5 篇全文）
...
**⚠️ 时间过滤纪律（强制，v4.9 更新）：**
- **证据窗口 = 最近 3 个月**：仅最近 3 个月内发布的研报/纪要可作证据进证据链；超窗口的仅作背景参考，不引用
- 研报库按周分文件夹（如 2026-08-04~2026-08-10/），标题常含日期（如 `GS-人形机器人-260703.pdf`=2026-07-03），据此判断时效
