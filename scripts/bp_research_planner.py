...
def _build_core_questions(entity: str) -> list[dict[str, Any]]:
    return [
        ...
        _core_question(
            ...
            ["bp_market_supply_chain", "bp_valuation_return", "bp_competition_positioning"],
        ...
        _core_question(
            ...
            ["bp_company_team_compliance", "bp_product_commercial", "bp_tech_ip_moat", "bp_market_supply_chain", "bp_competition_positioning"],
        ...
        _core_question(
            ...
            ["bp_company_team_compliance", "bp_product_commercial", "bp_tech_ip_moat", "bp_market_supply_chain", "bp_valuation_return"],
...
def _build_fact_requirements(stage_tier: str = "T3") -> list[dict[str, Any]]:
    ...
    return [
        ...
        _fact_requirement("commercial_stage", "研发、样机、试用、小批量、量产、规模销售等阶段证据", public + official, ["bp_product_commercial", "bp_valuation_return"], "critical"),
        _fact_requirement("customer_evidence", "客户、试用、合作、采购、招投标或合同线索", public + official, ["bp_product_commercial", "bp_competition_positioning"], cust_crit),
        _fact_requirement("order_evidence", "订单、收入、交付、产能利用或在手合同证据", public + official, ["bp_product_commercial", "bp_valuation_return"], order_crit),
        _fact_requirement("revenue_evidence", "营收规模、收入结构、回款或商业闭环证据", public + official, ["bp_product_commercial", "bp_valuation_return"], rev_crit),
        ...
        _fact_requirement("commercial_gap", "客户/订单/收入/交付无法验证造成的商业化缺口", public + official, ["bp_product_commercial", "bp_dealbreaker_risk"], comm_gap_crit),
...
def build_strategic_questions(entity: str, query: str, profile: dict[str, Any] | None = None) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _core_question(
            ...
            ["bp_product_commercial", "bp_dealbreaker_risk"],
...
def _default_claim_matrix(entity: str, stage_tier: str = "T3") -> list[dict[str, Any]]:
    defaults = [
        ...
        ("BC005", f"{entity} 的客户、订单、收入或渠道进展可以被独立验证。", "bp_product_commercial", "critical"),
