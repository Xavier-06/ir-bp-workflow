...
用法:
    python unified_search.py "solid state battery" --sources openalex,arxiv,s2 --max-results 30 --json
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--sources", default="openalex,arxiv,s2", help="数据源 (逗号分隔)")
